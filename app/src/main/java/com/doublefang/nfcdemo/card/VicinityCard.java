...
package com.doublefang.nfcdemo.card;

import android.content.res.Resources;
import android.nfc.tech.NfcV;

import com.doublefang.nfcdemo.R;
import com.doublefang.nfcdemo.Util;
...
final class VicinityCard {
	...
	private static String parseSzlibData(int type, byte[] raw, byte[] sta,
		...
		// final String blk = MyUtils.toHexString(raw, i, blkSize);
		// r.append("<br />").append(n++).append(": ").append(blk);
		// }

		// final String blk = MyUtils.toHexString(sta, 0, blkSize);
